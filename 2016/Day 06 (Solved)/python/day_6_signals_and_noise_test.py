...
class SignalsAndNoisePart2Tests(unittest.TestCase):

    def setUp(self):
        super(SignalsAndNoisePart2Tests, self).setUp()

    # def test_calculate_least_common_letter_of_given_list_returns_a_for_a_list_with_three_s_it(self):
    #     expected = 'b'
    #     column_list = ['a', 'a', 'a', 'b', 'c', 'c', 'c', 'b']
    #     actual = SignalsAndNoise.calculate_least_common_letter_of_given_list(column_list)
    #     self.assertEquals(expected, actual)
    #
    # def test_calculate_the_least_common_letter_of_given_lists_and_return_combined_string(self):
    #         expected = 'zaxxeshq'
    #         letter_list1 = ['a', 'm', 'a', 'm', 'z', 'a', 'm', 'm']
    #         letter_list2 = ['a', 'h', 'h', 'h', 's', 't', 't', 's']
    #         letter_list3 = ['o', 'h', 'h', 'x', 'o', 'h', 't', 't']
    #         letter_list4 = ['l', 'b', 'l', 'b', 'b', 'x', 'e', 'e']
    #         letter_list5 = ['p', 'p', 'o', 'b', 'o', 'o', 'b', 'e']
    #         letter_list6 = ['b', 'a', 'b', 'a', 'q', 'a', 'q', 's']
    #         letter_list7 = ['w', 's', 't', 't', 'w', 't', 's', 'h']
    #         letter_list8 = ['s', 'w', 's', 'w', 'q', 's', 't', 't']
    #         actual = SignalsAndNoise.calculate_least_common_letter_of_the_given_column_return_combined_string(letter_list1,
    #                                                                             letter_list2,
    #                                                                             letter_list3,
    #                                                                             letter_list4, letter_list5, letter_list6, letter_list7, letter_list8)
    #         self.assertEquals(expected, actual)

    def test_find_answer_for_day_6_part_2(self):
        expected = 'owlaxqvq'  # Got the right answer!
        actual = SignalsAndNoise.day_6_signals_and_noise_part_2()
        self.assertEquals(expected, actual)
